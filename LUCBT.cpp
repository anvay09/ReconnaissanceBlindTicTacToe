...
void calc_br_sequence_LUCB(PolicyVec& opponent_policy, char br_player, std::vector<std::string>& player_information_sets, int log_frequency, PolicyVec& player_br, 
    ...
    file_name = "data/sequence/" + exp_name + "_rbt_" + std::string(1, br_player) + "_C=" + std::to_string(C) + "_C_r=" + std::to_string(C_r) + "_seq-LUCB_reward_log_" + std::to_string(experiment_number) + ".txt";
