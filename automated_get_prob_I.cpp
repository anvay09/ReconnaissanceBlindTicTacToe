...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Probability of reaching " << I.get_hash() << " : " << prob_reaching_I << std::endl;

    // save probability to file
    std::string file_name = "prob_I_" + I.get_hash() + "_round_" + std::to_string(round) + ".txt";
    std::ofstream file;
    file.open(file_name);
    file << prob_reaching_I;
    file.close();
