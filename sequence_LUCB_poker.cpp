...
void calc_br_sequence_LUCB(PolicyVec& opponent_policy, char br_player, std::vector<std::string>& player_information_sets, int log_frequency, int m, PolicyVec& player_br, int experiment_number, char game, int iterations, int C, std::string& exp_name) {    
...
int main(int argc, char* argv[]) {
    ...
    while (experiment_num < experiments + start_index) {
        if (player == 'x') {
            ...
            // calc_br_sequence_LUCB(policy_obj_o, 'x', P1_information_sets, log_frequency, 1, uniform_x, experiment_num, game, iterations, C, exp_name);
        }
        else {
            PolicyVec uniform_o('o', P2_information_sets, game);
            // calc_br_sequence_LUCB(policy_obj_x, 'o', P2_information_sets, log_frequency, 1, uniform_o, experiment_num, game, iterations, C, exp_name);
        }
