...
if __name__ == "__main__":
    ...
    p1_policy_dict = json.load(open('data_files_new/P1_iteration_39_cfr_policy.json', 'r'))
    p1_policy_obj = Policy(policy_dict=p1_policy_dict, player='x')

    p2_policy_dict = json.load(open('data_files_new/P2_iteration_39_cfr_policy.json', 'r'))
