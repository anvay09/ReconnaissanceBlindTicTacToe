...
class LeducPokerEnv(gym.Env):
    ...
    def __init__(self, S, A, T, R, state_strings, player, gamma=0.99):
        ...
        self.state_strings = state_strings  # Dictionary mapping state index to state string
        self.gamma = gamma
        self.player = player
        
        self.starting_states = [0, 48, 96] if player == 'x' else [144, 165, 186]
...
if __name__ == "__main__":
    main('x')  # Change 'x' to 'o' for player 2
