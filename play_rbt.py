...
AI_player = None
P1_policy_name = 'P1_cfr_policy_round_100'
P1_file_name = 'data/Iterative_1/cfr_policy/{}.json'.format(P1_policy_name)
P1_stats_file = './data/Iterative_1/play_rbt_stats/{}_stats.json'.format(P1_policy_name)
P2_policy_name = 'P2_cfr_policy_round_100'
P2_file_name = 'data/Iterative_1/cfr_policy/{}.json'.format(P2_policy_name)
P2_stats_file = './data/Iterative_1/play_rbt_stats/{}_stats.json'.format(P2_policy_name)
use_policy = True
