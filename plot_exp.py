...
if __name__ == "__main__":
    ...
    # mccfr_x, mccfr_y = clean_data("data/eps_constant=0.100000_xaverage_mccfr_exploitability_log", mccfr_num_experiments, 99, 100000, 1,
    #                               1, interpolation=False)
    # onpath_x, onpath_y = clean_data("data/eps_constant=0.100000_xaverage_onpath_flipping_exploitability_log", onpath_num_experiments, 99, 100000, 1,
    #                                 1, interpolation=False)
    # upfront_x, upfront_y = clean_data("data/eps_constant=0.100000_xaverage_upfront_flipping_exploitability_log", upfront_num_experiments, 99, 100000,
    #                                   1, 1, interpolation=False)
    #
    # plt.plot(mccfr_x[0:99], mccfr_y[0:99], marker='', linewidth=1, color='green', linestyle='dotted',
    #          label='mccfr average for player ' + player + ', averaged over ' + str(onpath_num_experiments) + ' experiments')
    # plt.plot(onpath_x[0:99], onpath_y[0:99], marker='', linewidth=1, color='blue', linestyle='dotted',
    #          label='onpath average for player ' + player + ', averaged over ' + str(onpath_num_experiments) + ' experiments')
    # plt.plot(upfront_x[0:99], upfront_y[0:99], marker='', linewidth=1, color='red', linestyle='dotted',
    #          label='upfront average ' + player + ', averaged over ' + str(upfront_num_experiments) + ' experiments')
    ...
    # mccfr_x, mccfr_y = clean_data("data/eps_constant=0.100000_oaverage_mccfr_exploitability_log", mccfr_num_experiments, 99, 100000, 1,
    #                               1, interpolation=False)
    # onpath_x, onpath_y = clean_data("data/eps_constant=0.100000_oaverage_onpath_flipping_exploitability_log", onpath_num_experiments, 99, 100000, 1,
    #                                 1, interpolation=False)
    # upfront_x, upfront_y = clean_data("data/eps_constant=0.100000_oaverage_upfront_flipping_exploitability_log", upfront_num_experiments, 99, 100000,
    #                                   1, 1, interpolation=False)
    #
    # plt.plot(mccfr_x[0:99], mccfr_y[0:99], marker='', linewidth=1, color='green', linestyle='dotted',
    #          label='mccfr average for player ' + player + ', averaged over ' + str(onpath_num_experiments) + ' experiments')
    ...
    #          label='onpath average for player ' + player + ', averaged over ' + str(onpath_num_experiments) + ' experiments')
    # plt.plot(upfront_x[0:99], upfront_y[0:99], marker='', linewidth=1, color='red', linestyle='dotted',
    #          label='upfront average for player' + player + ', averaged over ' + str(upfront_num_experiments) + ' experiments')
